    ...
    <div className='bg-black text-white min-h-screen px-4 py-16'>
      ...
      <div className='max-w-4xl mx-auto'>
        ...
        <ul className='text-gray-400 list-disc pl-6 mb-6 space-y-2'>
          ...
          <li>For California residents (CCPA):
            <ul className='list-disc ml-6 mt-2 space-y-1'>
              ...
              <li>Submit a "Do Not Sell My Personal Information" request via <a href='mailto:privacy@matchably.kr' className='text-blue-400 underline'>privacy@matchably.kr</a></li>
            </ul>
          </li>
        </ul>
        ...
        <p className='text-gray-400 mb-6'>
          ...
          <br />
          📧 <a href='mailto:privacy@matchably.kr' className='text-blue-400 underline'>privacy@matchably.kr</a>
        </p>
      </div>
    </div>
  );
