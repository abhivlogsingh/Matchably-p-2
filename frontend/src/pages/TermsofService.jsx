  ...
  return (
    <div className='bg-black text-white min-h-screen px-4 py-16'>
      ...
      <div className='max-w-4xl mx-auto'>
        ...
        <p className='text-gray-400 mb-6'>
          You are responsible for maintaining your login credentials and activity. Provide accurate and current info. If compromised, notify us at <a href='mailto:support@matchably.kr' className='text-blue-400 underline'>support@matchably.kr</a>.
        </p>
        ...
        <p className='text-gray-400 mb-6'>
          Brands may use Matchably to launch campaigns, ship products, and collect user-generated content. We do not guarantee specific results but offer tools and metrics to support decisions.
        </p>
        ...
        <ul className='text-gray-400 list-disc pl-6 mb-6 space-y-2'>
          ...
          <li>You may revoke future use by emailing <a href='mailto:support@matchably.kr' className='text-blue-400 underline'>support@matchably.kr</a>. Past uses already published remain unaffected</li>
        </ul>
        ...
        <p className='text-gray-400 mb-6'>
          We may suspend or terminate your account if these Terms are violated. You may cancel at any time by contacting <a href='mailto:support@matchably.kr' className='text-blue-400 underline'>support@matchably.kr</a>.
        </p>
